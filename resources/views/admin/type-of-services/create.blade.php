...
<div class="container">
    <div class="row justify-content-center d-flex align-content-center" style="height:100vh">
        <div class="col-md-6">
            <form action="{{ route('admin.type-of-services.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="form-group">
                    <label for="type_of_service">{{ __('type_of_service') }}</label>
                    <input type="text" id="type_of_service" name="type_of_service" class="form-control @error('type_of_service') is-invalid @enderror" value="{{ old('type_of_service') }}" required>
